# `products/notes/notes-android.apk`

`notes-android.apk` is a **41,493-byte** Android package copied from the
validated NativeActivity APK precedent in [`../../../../experiments/poc-10-android-apk/hello.apk`](../../../../experiments/poc-10-android-apk/hello.apk.md).
